...
import 'package:samaj_parivaar_app/view/community/community_details_screen.dart';
...
class _CommunityCardState extends State<CommunityCard> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        widget.isJoined
            ? Get.to(() => CommunityDetailsScreen(data: widget.data))
            : Get.to(() => CommunityJoinRequestScreen(data: widget.data));
      },
      child: Container(
